...
int main (void){
  ...
  while(true){
    digitalWrite(BMS_OTG, HIGH); //disable boost mode
...
void initialize() {
  ...
  //digitalWrite(RF_ENABLE, LOW); //For V2 //---------------------FIX ME This is specific to p-channel fets, Off is HIGH, On is LOW---------------------
  digitalWrite(RF_ENABLE, HIGH); //For V3  //Fixed
  ask_driver.init();
  serialWriteString("Started Radio\n");
...
void initializeTimer2Sleep(){
    ...
    while ( (1<<TCN2UB)&ASSR | (1<<OCR2BUB)&ASSR | (1<<TCR2BUB)&ASSR);
